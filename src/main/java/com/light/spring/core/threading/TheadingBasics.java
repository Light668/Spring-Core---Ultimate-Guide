...
public class TheadingBasics {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		/*
		 * Future<Integer> result = Executors.newFixedThreadPool(1).submit(new
		 * MyCallable()); System.out.println(result.get());
		 */

		/*
		 * Executor directExecutor = new DirectExecutor(); directExecutor.execute(new
		 * MyRunnable());
		 */
